...
export class MyGroups extends React.Component {
    ...
    console.log(google_user)
        let data = {
            ...
            // "my_infos" : "asda",
                "friends":[
                    {  "id" : 0,"name": "Team Korili Pokybird", "size" : 4, "Age": 22, "withFriendsSince" : "15.02.2021", "vaccines" : [{"vaccine": "covid19"}, {"vaccine": "asi1"}, {"vaccine": "asi2"}, {"vaccine": "asi3"}]} ,
                    {  "id" : 1, "name": "Istanbul Trip", "size" : 8, "Age": 22, "withFriendsSince" :"15.02.2021", "vaccines" : [{"vaccine": "covid19"}, {"vaccine": "asi1"}, {"vaccine": "asi2"}, {"vaccine": "asi3"}]} ,
                    {  "id" : 2, "name": "Basketball Team", "size" : 12, "Age": 22, "withFriendsSince" :"15.02.2021", "vaccines" : [{"vaccine": "covid19"}, {"vaccine": "asi1"}, {"vaccine": "asi2"}, {"vaccine": "asi3"}]} ,
                ]
        };
